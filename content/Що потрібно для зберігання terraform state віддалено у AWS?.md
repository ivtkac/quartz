...
aliases:
---
Для початку потрібно **мануально** (або [[How to store terraform remotely in AWS S3 bucket?|за допомогою terraform]] :)  створити два ключових ресурси перед збереження віддалено конфігурацію:
